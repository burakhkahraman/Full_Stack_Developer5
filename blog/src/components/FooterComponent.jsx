...
class FooterComponent extends Component {
  ...
  render() {
    ...
    let footerTopSide = (
      <section className="d-flex mt-5 justify-content-center justify-content-lg-between p-4">
        ...
        <div>
          ...
          <a href="https://www.twitter.com" className="me-4 link-secondary">
            <i className="text-warning fab fa-twitter"></i>
          </a>
          <a href="https://www.google.com" className="me-4 link-secondary">
            <i className="text-primary fab fa-google"></i>
          </a>
        </div>
      </section>
    );
    ...
    let footerMiddleSide = (
      <div className="col-md-2 col-lg-2 col-xl-4 mx-auto mb-4">
        <h6 className="text-uppercase fw-bold mb-4">
          <i className="fas fa-gem me-3 text-secondary"></i>{t('company')}
        </h6>
    ...
    return (
      <React.Fragment>
        <footer className='bg-dark App-header44 text-center text-white fixed-bottom44' style={{ marginTop: "20rem" }}>
          {footerTopSide}
          ...
          <div className="text-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.025)" }}>
            2020
            © {newDateYear()} {t('Copyright')}: 
            <a className="text-reset fw-bold" href="https://example.com">{this.props.site}</a>
          </div>
        </footer>
      </React.Fragment>
    );
